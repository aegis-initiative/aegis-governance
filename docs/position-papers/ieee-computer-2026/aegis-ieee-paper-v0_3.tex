...
\centering
\caption{AEGIS architecture: the Tool Proxy intercepts agent tool calls, routes them through the Governance Gateway to the Decision Engine, and records every decision in the tamper-evident audit trail. No action reaches infrastructure without a governance decision.}
...
\begin{table}[!t]
% TODO: Related work differentiation matrix
\centering
\caption{Differentiation of AEGIS from representative related work across five governance dimensions: action-boundary enforcement, federated trust, tamper-evident audit, NIST AI RMF alignment, and open specification.}
