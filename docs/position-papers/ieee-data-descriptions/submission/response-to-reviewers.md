...
1. **Dataset version update.** As cleared by the Editor-in-Chief (Prof. Stephen Makonin) in email correspondence dated 2026-04-24, the descriptor is updated to reflect ATX-1 v2.3 (released 2026-04-24; IEEE DataPort DOI [10.21227/jr43-0571](https://doi.org/10.21227/jr43-0571); open-access via the auto-minted aegis-governance repository snapshots on Zenodo, concept [10.5281/zenodo.19162184](https://doi.org/10.5281/zenodo.19162184)) rather than the v1.0 baseline reviewed by the original referees. v2.3 removes the `severity` field in alignment with MITRE ATT&CK and ATLAS conventions; this version bump simultaneously resolves Reviewer 1's methodology concern (R1-1) and Associate Editor concern AE-1. All numerical claims and figures are updated accordingly. v1.0 remains frozen at its original IEEE DataPort DOI (10.21227/f87b-1d57) for reproducibility of the reviewed record.
