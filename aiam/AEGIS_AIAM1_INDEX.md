...
| **Intent claim** | A structured assertion of the purpose of a specific action at the moment it is taken. | Not present in AGP-1. AGP-1 treats intent as implicit in ACTION_PROPOSE parameters. AIAM-1 intent claims extend, not replace, AGP-1 message structures. |
